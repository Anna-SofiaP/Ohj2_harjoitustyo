 ...
 * @version 2022.05.11 10:09:18 // Generated by ComTest
 *
 */
...
public class MerkinnatTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testEtsiKayttajaId510 
   * @throws SailoException when error
   */
  @Test
  public void testEtsiKayttajaId510() throws SailoException {    // Merkinnat: 510
    Merkinnat merkinnat = new Merkinnat(); 
    Merkinta pvm1 = new Merkinta(1), pvm2 = new Merkinta(2), pvm3 = new Merkinta(2); 
    pvm1.merkinnanLisays(); pvm2.merkinnanLisays(); pvm3.merkinnanLisays(); 
    int id1 = pvm1.getKayttajaId(); 
    merkinnat.lisaa(pvm1); merkinnat.lisaa(pvm2); merkinnat.lisaa(pvm3); 
    assertEquals("From: Merkinnat line: 517", 0, merkinnat.etsiKayttajaId(id1)); 
    assertEquals("From: Merkinnat line: 518", 1, merkinnat.etsiKayttajaId(id1+1)); 
    assertEquals("From: Merkinnat line: 519", -1, merkinnat.etsiKayttajaId(id1+2)); 
    assertEquals("From: Merkinnat line: 520", -1, merkinnat.etsiKayttajaId(id1+5)); 
  } // Generated by ComTest END
}