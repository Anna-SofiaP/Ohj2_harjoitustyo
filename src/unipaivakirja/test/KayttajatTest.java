 ...
 * @version 2022.05.04 15:47:41 // Generated by ComTest
 *
 */
...
public class KayttajatTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testKayttajatIterator295 
   * @throws SailoException when error
   */
  @Test
  public void testKayttajatIterator295() throws SailoException {    // Kayttajat: 295
    Kayttajat kayttajat = new Kayttajat(); 
    Kayttaja nea = new Kayttaja(), ansku = new Kayttaja(); 
    ...
    assertEquals("From: Kayttajat line: 314", tulos, ids.toString()); 
    ids = new StringBuffer(30); 
    for (Iterator<Kayttaja>  i=kayttajat.iterator(); i.hasNext(); ) { // ja iteraattorin toimintaa
    Kayttaja kayttaja = i.next(); 
    ids.append(" "+kayttaja.getKayttajaId()); 
    }
    assertEquals("From: Kayttajat line: 322", tulos, ids.toString()); 
    Iterator<Kayttaja>  i=kayttajat.iterator(); 
    assertEquals("From: Kayttajat line: 325", true, i.next() == nea); 
    assertEquals("From: Kayttajat line: 326", true, i.next() == ansku); 
    assertEquals("From: Kayttajat line: 327", true, i.next() == nea); 
    try {
    i.next(); 
    fail("Kayttajat: 329 Did not throw NoSuchElementException");
   ...
   */
  @Test
  public void testPoista401() throws SailoException {    // Kayttajat: 401
    Kayttajat kayttajat = new Kayttajat(); 
    ...
    assertEquals("From: Kayttajat line: 408", 1, kayttajat.poista(id1+1)); assertEquals("From: Kayttajat line: 408", 2, kayttajat.getLkm()); 
    assertEquals("From: Kayttajat line: 409", 1, kayttajat.poista(id1)); assertEquals("From: Kayttajat line: 409", 1, kayttajat.getLkm()); 
    assertEquals("From: Kayttajat line: 410", 0, kayttajat.poista(id1+3)); assertEquals("From: Kayttajat line: 410", 1, kayttajat.getLkm()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testEtsiId430() throws SailoException {    // Kayttajat: 430
    Kayttajat kayttajat = new Kayttajat(); 
    Kayttaja nea = new Kayttaja(), ansku = new Kayttaja(), liisa = new Kayttaja(); 
    nea.rekisteroi(); ansku.rekisteroi(); liisa.rekisteroi(); 
    int id1 = nea.getKayttajaId(); 
    kayttajat.lisaa(nea); kayttajat.lisaa(ansku); kayttajat.lisaa(liisa); 
    assertEquals("From: Kayttajat line: 437", 1, kayttajat.etsiId(id1+1)); 
    assertEquals("From: Kayttajat line: 438", 2, kayttajat.etsiId(id1+2)); 
  } // Generated by ComTest END
}